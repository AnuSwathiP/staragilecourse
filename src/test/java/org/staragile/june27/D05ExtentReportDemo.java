...
public class D05ExtentReportDemo {
    ...
    //this dependency we have to paste and sync in pom.xml
    public static void main(String[] args) {
        ...
        driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
        driver.get("https://www.google.com");
        driver.findElement(By.name("q")).sendKeys("Extent Report", Keys.ENTER);//in searchbox "Extent Report" addeda and pressed enter
        driver.close();
