...
public class D04DataDrivenTesting {
    WebDriver driver;
//here dataprovider annotation in D03ReadFromExcel.class,to use that here we have to mention that class name in
//    dataProviderClass
    @Test(dataProvider = "readData", dataProviderClass = org.staragile.june27.D03ReadFromExcel.class)
